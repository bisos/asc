...
typeset RcsId="$Id: lcaQmailSrcDebPkgRePub.sh,v 1.3 2020-02-03 01:28:40 lsipusr Exp $"
# *CopyLeft*
...
SEED="
* /[dblock]/--Seed/: /opt/public/osmt/bin/seedPkgRePub.sh
"
if [ "${loadFiles}" == "" ] ; then
...
typeset -A prp_basePkg=(
    [pkgRePubName]="qmail-src_1.03-49.2_all.deb"
    [pkgRePubSrcStableUrl]="http://http.us.debian.org/debian/pool/non-free/q/qmail/qmail-src_1.03-49.2_all.deb"
