...
"
FILE="
*  /This File/ :: /bisos/asc/mail/bin/lcaSpamABinsPrep.sh 
"
if [ "${loadFiles}" == "" ] ; then
...
_CommentBegin_
*  [[elisp:(org-cycle)][| ]]  [[elisp:(blee:ppmm:org-mode-toggle)][Nat]] [[elisp:(beginning-of-buffer)][Top]] [[elisp:(delete-other-windows)][(1)]] || Apt-Pkg       :: spamassassin [[elisp:(org-cycle)][| ]]
_CommentEnd_
