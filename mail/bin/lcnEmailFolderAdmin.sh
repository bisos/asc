...
typeset RcsId="$Id: lcnEmailFolderAdmin.sh,v 1.1.1.1 2016-06-08 23:49:51 lsipusr Exp $"
...
${G_myName} ${extraInfo} -p fileSizeLimit=262144 -p scanWith="spamA"  -p splitFolder=${oneSplitFolder} -i folderHamSpam
...
maildir2mbox # part of qmail Needs Env Vars
=== Misc ===
_EOF_
}
