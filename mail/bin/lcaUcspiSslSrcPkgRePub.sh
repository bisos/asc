...
typeset RcsId="$Id: lcaUcspiSslSrcPkgRePub.sh,v 1.3 2020-02-03 01:28:40 lsipusr Exp $"
# *CopyLeft*
...
"
FILE="
*  /This File/ :: /bisos/git/auth/bxRepos/bisos/asc/mail/bin/lcaUcspiSslSrcPkgRePub.sh
"
if [ "${loadFiles}" == "" ] ; then
...
pkgRePubParameters_DEBIAN_11 () { pkgRePubParameters_commonDebian; }
...
typeset -A prp_basePkg=(
    [pkgRePubName]=ucspi-ssl-0.73.tar.gz
    # [pkgRePubSrcStableUrl]="http://www.superscript.com/ucspi-ssl/ucspi-ssl-0.73.tar.gz"
    [pkgRePubSrcStableUrl]="http://www.bybinary.org/republish/ubuntu/1804/all/ucspi-ssl-0.73.tar.gz"
...
_CommentBegin_
*     ====[[elisp:(org-cycle)][Fold]]==== patch1 (Common)
_CommentEnd_


typeset -A prp_patch1=(
    [pkgRePubName]="ucspi-ssl-0.70-ucspitls-0.1.patch"
    # [pkgRePubSrcStableUrl]="http://www.suspectclass.com/~sgifford/ucspi-tls/files/ucspi-ssl-0.70-ucspitls-0.1.patch"
    [pkgRePubSrcStableUrl]="http://www.bybinary.org/republish/ubuntu/1804/all/ucspi-ssl-0.70-ucspitls-0.1.patch"
    [pkgRePubArchType]="all"
    [pkgRePubDistDests]="localDist"
)


#
# Execute based on platform generation.
#
vis_pkgRePubParameters
