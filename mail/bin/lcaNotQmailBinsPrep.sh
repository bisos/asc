...
_CommentBegin_
*      ======[[elisp:(org-cycle)][Fold]]====== Custom-Pkg: notqmail
_CommentEnd_


item_notqmail () {
  distFamilyGenerationHookRun binsPrep_notqmail
}

#binsPrep_qmail_DEFAULT_DEFAULT () { binsPrepAptPkgNameSet "notqmail"; }
binsPrep_notqmail_DEFAULT_DEFAULT () {
    mmaThisPkgName="notqmail"
...
binsPrep_notqmail_DEBIAN_12 () {
    ...
    function customInstallScript {
        ...
        inBaseDirDo /tmp wget https://download.opensuse.org/repositories/home:/notqmail/Debian_12/amd64/notqmail_1.09-1.1+1.3_amd64.deb
        
        opDo sudo apt-get install -y /tmp/notqmail_1.09-1.1+1.3_amd64.deb
    }
    binsPrep_installPreHook="qmail_installPre"
    binsPrep_installPostHook="qmail_installPost"
}
...
binsPrep_qmail_DEBIAN_11 () {
    ...
    function customInstallScript {
        #lpDo sudo dpkg --purge --force-all zoom
        inBaseDirDo /tmp wget https://download.opensuse.org/repositories/home:/notqmail/Debian_11/amd64/notqmail_1.09-1.1+1.3_amd64.deb
