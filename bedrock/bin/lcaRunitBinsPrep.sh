...
"
FILE="
*  /This File/ :: /bisos/asc/bedrock/bin/lcaDaemontoolsBinsPrep.sh 
"
if [ "${loadFiles}" == "" ] ; then
...
Xref-Here-
**      ====[[elisp:(org-cycle)][Fold]]==== [[file:/libre/ByStar/InitialTemplates/activeDocs/bxServices/servicesManage/bxSupervision/fullUsagePanel-en.org::Xref-BxSupervision][Panel Roadmap Documentation]]
_CommentEnd_
...
function examplesHookPostNOT {
  cat  << _EOF_
----- ADDITIONS -------
${G_myName} -i forFutureUse
_EOF_
}

function vis_pipInstallCommon {
  opDo echo forFutureUse
}

# }}}


####+BEGIN: bx:dblock:lsip:binsprep:apt :module "runit"
_CommentBegin_
*  [[elisp:(org-cycle)][| ]]  [[elisp:(blee:ppmm:org-mode-toggle)][Nat]] [[elisp:(beginning-of-buffer)][Top]] [[elisp:(delete-other-windows)][(1)]] || Apt-Pkg       :: runit [[elisp:(org-cycle)][| ]]
_CommentEnd_
item_runit () { distFamilyGenerationHookRun binsPrep_runit; }

binsPrep_runit_DEFAULT_DEFAULT () { binsPrepAptPkgNameSet "runit"; }
