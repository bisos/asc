...
typeset RcsId="$Id: lcaGenewebBinsPrep.sh,v 1.1.1.1 2016-06-08 23:49:51 lsipusr Exp $"
# *CopyLeft*
...
"
FILE="
*  /This File/ :: /bisos/asc/geneweb7/bin/lcaGeneweb7BinsPrep.sh
"
if [ "${loadFiles}" == "" ] ; then
...
####+BEGIN: bx:dblock:lsip:binsprep:apt :module "geneweb"
_CommentBegin_
*      ======[[elisp:(org-cycle)][Fold]]====== Apt-Pkg: geneweb
_CommentEnd_
item_geneweb () { distFamilyGenerationHookRun binsPrep_geneweb; }

binsPrep_geneweb_DEFAULT_DEFAULT () { binsPrepAptPkgNameSet "geneweb"; }
...
item_geneweb7 () {
  distFamilyGenerationHookRun binsPrep_geneweb7
}

binsPrep_geneweb7_DEFAULT_DEFAULT () {
    mmaThisPkgName="geneweb7"
    ...
    binsPrep_installPostHook="geneweb7_installPost"

    function customInstallScript {

        local geneweb7Url="https://github.com/geneweb/geneweb/releases/download/v7.0.0/geneweb-linux-88536ed4.zip"

        opDo wget -O /bisos/asc/geneweb7/geneweb-linux.zip ${geneweb7Url}
        inBaseDirDo /bisos/asc/geneweb7 unzip /bisos/asc/geneweb7/geneweb-linux.zip
    }
}

function geneweb7_installPost {
    G_funcEntry
    function describeF {  G_funcEntryShow; cat  << _EOF_
_EOF_
                       }
...
####+BEGIN: bx:dblock:lsip:binsprep:apt :module "gwtp"
_CommentBegin_
*      ======[[elisp:(org-cycle)][Fold]]====== Apt-Pkg: gwtp
_CommentEnd_
item_gwtp () { distFamilyGenerationHookRun binsPrep_gwtp; }

binsPrep_gwtp_DEFAULT_DEFAULT () { binsPrepAptPkgNameSet "gwtp"; }
